...
export const fonstStyle = () => {
	let fontsFile = `${app.path.src.styles}/base/fonts.sass`;
	...
	fs.readdir(app.path.build.fonts, function (err, fontsFiles) {
		if (fontsFiles) {
			...
			if (!fs.existsSync(fontsFile)) {
				...
				console.log(`Файл ${app.path.src.styles}/base/fonts.scss уже существует. Для обновления файла нужно его удалить!`);
